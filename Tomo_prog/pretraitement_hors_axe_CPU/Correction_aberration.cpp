...
///calculate constant table, to avoid calculation in a loop
...
///load object mask used tocorrect aberrations
...
///Generate the numerical value of the vector [1,x,x^2,xy,y,y^2] for each (x,y) outside the  mask area, undersampled to accelerate calculations  ("US"=undersampled)
