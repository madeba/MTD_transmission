...
// SAV_Tiff2D(grady_enroul_fft,"Re","/home/mat/tomo_test/TF_grady_non_GPU.tif",1);
 ...
 //SAV_Tiff2D(grady_IntM,"/home/mat/tomo_test/grady_intM_non_GPU.tif",1);

  for(size_t cpt=0;cpt<nbPix;cpt++){
    //IntM[cpt].real(round( 100*IntM[cpt].real() )/100);
    phase_deroul[cpt]=phase_enroul[cpt]+M_2PI*IntM[cpt].real();
  }
//  SAV_Tiff2D(IntM,"Re","/home/mat/tomo_test/Int_M_non_GPU.tiff",1);
}
...
//  vector<vecteur> kvect(nbPix),kvect_shift(nbPix);
  ...
  //SAV_Tiff2D(kvect_mod_sq,nbPix,"/home/mat/tomo_test/kvect_mod.bin",t_float,"wb");
