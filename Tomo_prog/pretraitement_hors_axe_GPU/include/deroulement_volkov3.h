...
void  gradient_fft3(std::vector<double> const &gradx,std:: vector<double> const& grady, std::vector<std::complex<double>> &sortie,std::vector<vecteur> &kvect_shift, FFTW_init &param_c2c);
