...
af::array coupe(af::array img_orig,Var2D dim_crop, Var2D coord_coin);
void holo2TF_UBorn_GPU(af::array  &holo1,af::array &TF_UBornTot,Var2D dimROI,Var2D dim2DHA,Var2D coinHA, size_t NbAngleOk, af::array  const &tukeyHolo);
