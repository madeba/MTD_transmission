#ifndef DEF_DEROUL// Si la constante n'a pas été définie` le fichier n'a jamais été inclus
#include "struct.h"
#define DEF_DEROUL
#include <vector>
...
void phaseUnwrapping_Mat(Var2D taille, std::vector<double> WrappedImage, double *UnwrappedImage);
