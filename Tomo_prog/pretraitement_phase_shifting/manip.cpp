...
void manip::init()
{
   ...
   // circle_cy=extract_val("CIRCLE_CY",fic_cfg_manip);
    ...
    ///-----------------sauvegarder les paramètres pour infos-------------------------------------------------------------------
    ...
    fichier_sav_parametre1<<"\n##################### INFO Reconstruction ##################\n"<<endl;
    fichier_sav_parametre1<<"+----------------+----------------+"<<endl;
    fichier_sav_parametre1<<"|    Grandeur    |    Valeur      |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|    Tp Holo     |     "<<tailleTheoPixelHolo<<" nm      |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|     Champ      |     "<<round(IMAGE_DIMX*tailleTheoPixelHolo/1000)<<" µm      |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|     R_Ewald    |     "<<round(R_Ewald)<<" pixels |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|     NXMAX_theo |     "<<round(R_Ewald*NA/n0)<<" pixels |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"| Taille chp cplx|     "<<2*round(R_Ewald*NA/n0)<<" pixels |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|    Tp Chp cplx |     "<<round(tailleTheoPixelHolo/(2*NXMAX_theo)*dimROI.x)<<" nm     |"<<endl;
    fichier_sav_parametre1<<"|---------------------------------|"<<endl;
    fichier_sav_parametre1<<"|    Tp Tomo theo|     "<<(2*NXMAX_theo)/dim_final*tailleTheoPixelHolo/(2*NXMAX_theo)*dimROI.x<<" nm      |"<<endl;
    fichier_sav_parametre1<<"+---------------------------------+"<<endl;
    fichier_sav_parametre1<<"\n##################### FIN INFO Reconstruction ##################\n"<<endl;

    fichier_sav_parametre1.close();
